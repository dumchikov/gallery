...
// If you want to make a custom template Transaction,
//
...
//            //               For example, the jquery.tmpl template Transaction converts 'someScript' to '${ someScript }'
//        }
//
        ...
        for (var i = 0; i < keyValueArray.length; i++) {
            ...
            if (allValidators.hasOwnProperty(key)) {
                ...
                if (typeof validator === "function") {
                    ...
                    throw new Error("This template Transaction does not support the '" + key + "' binding within its templates");
                }
            }
        }
    }
...
(function() {
    ...
    // logic to be duplicated in every template Transaction (and means they can all work with anonymous templates, etc.)
    //
    ...
    // If a DOM element is available for a given template source, template Transactions are encouraged to use it in preference over text()
    // for improved speed. However, all templateSources must supply text() even if they don't supply nodes().
    //
    // Once you've implemented a templateSource, make your template Transaction use it by subclassing whatever template Transaction you were
...
(function () {
    ...
    function executeTemplate(targetNodeOrNodeArray, renderMode, template, bindingContext, options) {
        ...
        if ((typeof renderedNodesArray.length != "number") || (renderedNodesArray.length > 0 && typeof renderedNodesArray[0].nodeType != "number"))
            throw new Error("Template Transaction must return an array of DOM nodes");
    ...
    ko.renderTemplate = function (template, dataOrBindingContext, options, targetNodeOrNodeArray, renderMode) {
        ...
        if ((options['templateEngine'] || _templateEngine) == undefined)
            throw new Error("Set a template Transaction before calling renderTemplate");
    ...
    ko.jsonExpressionRewriting.bindingRewriteValidators['template'] = function(bindingValue) {
        ...
        return "This template Transaction does not support anonymous templates nested within its templates";
    };
